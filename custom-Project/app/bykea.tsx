      ...
      {/* FooterCards View */}
          <View style={styles.footerCards}>
            <View style={styles.row}>
              <Cards text={'Carpol'} icon={'electric-car'} bgColor={'#CCEFFC'}/>
              <Cards text={'Ride'} icon={'bike-scooter'} bgColor={'#B3EAB9'}/>
            </View>
            <View style={styles.row}>
            <Cards text={'Delivery'} icon={'delivery-dining'} bgColor={'#E7D5BF'}/>
            <Cards text={'Mobilies'} icon={'mobile-screen-share'} bgColor={'#AEB6F0'}/>
            </View>
            <View style={styles.row}>
            <Cards text={'Shops'} icon={'add-shopping-cart'} bgColor={'#99B0C8'}/>
            <Cards text={'Rentals'} icon={'car-rental'} bgColor={'#CBCB88'}/>
            </View>
          </View>
    </View>
  );
}
const Cards=({bgColor,text,icon}:
{bgColor:string,text:string,icon:any})=>{
return(
  <View style={[styles.card,{backgroundColor:bgColor}]}>
    <Text style={{textAlign:'right'}}>{text}</Text>
    <MaterialIcons name={icon} size={45} color="black" />
  </View>
)
}
